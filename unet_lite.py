...
class UNet_Lite(nn.Module):
    ...
    def __init__(self, frames, action_dim, mode, stochastic, noise_sigma):
        super(UNet_Lite, self).__init__() # "Connects" class to parent/super class (nn.Module) - Unet is now an object of nn.module
        ...
        # Contracting path
        self.enc1 = Block(frame_in_channels, 32)
        ...
        self.transpose4  = nn.ConvTranspose2d(64, 32, kernel_size=2, stride=2)
        self.dec4 = Block(64,  32)

        self.out = nn.Conv2d(32, 3*frames, kernel_size=1)
